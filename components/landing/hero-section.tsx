...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[720px] min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      {/* Background video */}
      ...
      {/* Subtle grid lines */}
      <div className="absolute inset-0 z-[2] overflow-hidden pointer-events-none opacity-20 animate-pulse-glow">
        {[...Array(8)].map((_, i) => (
          <div
            key={`h-${i}`}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="w-full max-w-3xl lg:max-w-[55%]">
        {/* Eyebrow */}
        <div 
        ...
        <div className="mb-12">
          <h1 
            className={`text-left text-[clamp(2.8rem,11vw,7rem)] font-display leading-[0.92] tracking-tight text-white transition-all duration-1000 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <span className="block">Distributed compute,</span>

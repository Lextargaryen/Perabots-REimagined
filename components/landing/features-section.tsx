...
function ParticleVisualization() {
  ...
  return (
    <canvas
      ref={canvasRef}
      className="absolute inset-0 pointer-events-auto animate-float-slow"
        ...
        <div className="relative mb-24 lg:mb-32">
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-7">
              ...
              <h2
                className={`text-5xl sm:text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
